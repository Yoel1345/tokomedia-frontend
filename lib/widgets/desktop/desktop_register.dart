...
import '../desktop/desktop_verify.dart';
  ...
  void _handleDaftar() {
    ...
    Future.delayed(const Duration(milliseconds: 600), () {
      if (mounted) {
        ...
        // Tampilkan dialog konfirmasi nomor HP
        _showConfirmDialog(input);
      }
    });
  }

  void _showConfirmDialog(String phone) {
    showDialog(
      context: context,
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                DesktopVerify(phoneOrEmail: phone)));
                  },
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (_) => const DesktopLogin())),
