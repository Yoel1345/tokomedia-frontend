...
class DesktopVerify extends StatelessWidget {
  final String phoneOrEmail;
  const DesktopVerify({super.key, required this.phoneOrEmail});
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildVerifyOption(
                                ...
                                title: 'WhatsApp ke',
                                subtitle:
                                    '62${phoneOrEmail.replaceFirst('0', '')}',
                              ),
    ...
    return InkWell(
      onTap: () {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text('Kode verifikasi dikirim ke $subtitle (simulasi)')),
        );
