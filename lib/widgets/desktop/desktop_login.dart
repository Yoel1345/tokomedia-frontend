    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Body — pakai LayoutBuilder agar tahu ukuran area
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                // Lebar & tinggi gambar samping (sesuaikan jika perlu)
                const imgW = 280.0;
                const imgH = 420.0;
                ...
                // Gambar kiri: ujung kanannya menempel ke kiri form (center - 150 - gap)
                final leftImgLeft = centerX - 150 - imgW - 16;

                // Gambar kanan: ujung kirinya menempel ke kanan form (center + 150 + gap)
                final rightImgLeft = centerX + 150 + 16;
            ...
            children: [
              ...
              TextButton(
                onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const DesktopRegister()),
                ),
